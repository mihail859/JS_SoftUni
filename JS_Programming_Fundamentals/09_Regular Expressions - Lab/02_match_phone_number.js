function matchPhoneNumber(arrWithPhoneNumbers){

    const pattern = /\+359([ -]){1}2\1\d{3}\1\d{4}\b/gm;

    let strPhones = arrWithPhoneNumbers[0]
    let result = strPhones.match(pattern)
